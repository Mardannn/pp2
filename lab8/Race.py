...
myCar = pygame.image.load('Player.png').convert_alpha()
myCar = pygame.transform.scale(myCar, (50, 100))
enemyCar = pygame.image.load('Enemy.png').convert_alpha()
enemyCar = pygame.transform.scale(enemyCar, (50, 100))
coin = pygame.image.load('coin.png').convert_alpha()
FPS = pygame.time.Clock()
pygame.display.set_caption("Race")   
font = pygame.font.SysFont("Verdana", 60)
accident_sound=pygame.mixer.Sound('caracc.mp3')
